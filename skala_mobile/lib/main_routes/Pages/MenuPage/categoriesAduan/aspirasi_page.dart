...
class MainMenuAspirasiPage extends StatelessWidget {
  const MainMenuAspirasiPage({super.key});
    ...
    return Scaffold(
      ...
      appBar: const MainCustomAppBarTitle(
        ...
        titleStyle: TextStyle(
          color: Color.fromARGB(255, 222, 128, 100),
          ...
          children: [
            ...
            Container(
              ...
              child: const DescriptionContent(
                description: MainConstantData.kategoriAspirasi,
              ),
            ),
            Padding(
              padding: EdgeInsets.symmetric(
